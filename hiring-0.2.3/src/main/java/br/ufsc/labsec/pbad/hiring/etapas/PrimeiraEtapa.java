    ...
    public class PrimeiraEtapa {
        ...
        public static void executarEtapa() {
            ...
            try {
                ...
                // Gera um resumo criptográfico do arquivo de entrada
                byte[] resumoCriptografico = resumidor.resumir(arquivoDeEntrada);
                System.out.println("Resumo criptográfico gerado com sucesso.");

                // Escreve o resumo criptográfico em disco
                resumidor.escreveResumoEmDisco(resumoCriptografico, Constantes.caminhoResumoCriptografico);
                System.out.println("Resumo criptográfico salvo com sucesso.");
